    ...
    <PageTransition variant="page">
      <div className="flex-1 w-full">
        <div className="container mx-auto px-4 py-6 max-w-7xl">
          ...
          {/* Filters Section */}
          <div className="mb-8 bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 p-5 border border-white/20 dark:border-gray-700/50">
              ...
              {filteredItems.map((item) => {
                ...
                return (
                  <div
                    ...
                    className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden hover:shadow-xl hover:shadow-primary/10 hover:border-accent/50 dark:hover:border-primary-light/50 hover:-translate-y-1 transition-all duration-400 cursor-pointer flex flex-col relative"
                  >
                    {/* Quick Actions */}
                    <QuickActions
                      itemId={item.id}
